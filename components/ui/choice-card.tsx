  ...
  return (
    ...
    >
      ...
      <span className="min-w-0">
        <span className="block text-sm font-semibold text-foreground group-has-checked:text-primary-strong sm:text-base">
          {title}
        </span>
        {description ? (
